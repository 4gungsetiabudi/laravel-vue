...
class HomeController extends Controller
{
    public function home()
    {
        ...
        $label_donut = Publisher::orderBy('publishers.id', 'asc')->join('books.publisher_id', '=', 'penerbits.id')->groupBy('publihser_name')->pluck('publisher_name');
    ...
    public function catalog()
    {
        ...
        return view('admin.catalog.catalog', compact('catalog_data'));
    }
