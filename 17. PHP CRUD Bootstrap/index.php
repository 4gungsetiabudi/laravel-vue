...
<center>
    <a href="index.php">BUKU</a> ||ಠ▃ಠ||
    <a href="penerbit.php">Penerbit</a> ||ಠ▃ಠ||
    <a href="pengarang.php">Pengarang</a> ||ಠ▃ಠ||
    <a href="katalog.php">Katalog</a> 
    <hr>
</center>
📘
<a href="add.php" class="btn btn-primary" role="button">Tambahkan Buku </a> 📘<br/><br/> 
 
    <table class="table table-striped" width='75%' border=1>
